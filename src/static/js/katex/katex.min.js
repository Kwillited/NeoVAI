  ...
  return (function () {
    ...
    function pt(e, t) {
      ...
      (a.length > 0 && s.push(mt(a, t)),
        r ? ((i = mt(ot(r, t, !0))), (i.classes = ['tag']), s.push(i)) : o && s.push(o));
    ...
    function Mt(e, t, r, n, o) {
      ...
      let i;
      i =
        1 === s.length && s[0] instanceof dt && l.contains(['mrow', 'mtable'], s[0].type)
          ? s[0]
    ...
    var Nt = function (e, t, r, n, o) {
        ...
        if (/fbox|color|angl/.test(t)) {
          ...
          const e = [];
          (/^[bx]cancel$/.test(t) &&
            e.push(new ee({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })),
            /^x?cancel$/.test(t) &&
              e.push(new ee({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' })));
    ...
    ($e({
      ...
      handler(e) {
        ...
        if ($t[o.text])
          return (
            ('\\global' !== r && '\\\\globallong' !== r) || (o.text = $t[o.text]),
    ...
    ($e({
      ...
      htmlBuilder: (e, t) =>
        '.' === e.delim ? Pe.makeSpan([e.mclass]) : wr.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
      mathmlBuilder: (e) => {
        const t = [];
    ...
    const Dr = function (e, t) {
        ...
        for (o = 0, A = 0; o < a || A < S.length; ++o, ++A) {
          ...
          for (; 'separator' === c.type; ) {
            if (
              (p ||
                ((z = Pe.makeSpan(['arraycolsep'], [])), (z.style.width = F(t.fontMetrics().doubleRuleSep)), M.push(z)),
      ...
      Pr = function (e, t) {
        ...
        return (
          ...
          e.arraystretch &&
            e.arraystretch < 1 &&
            ((s = new ft.MathNode('mstyle', [s])), s.setAttribute('scriptlevel', '1')),
          s
        );
      },
      Fr = function (e, t) {
    ...
    const en = (e, t, r, n, o, s, i) => {
      ...
      nn = (e, t) => {
        let r;
        if (e.symbol)
          ((r = new dt('mo', [bt(e.name, e.mode)])), l.contains(tn, e.name) && r.setAttribute('largeop', 'false'));
    ...
    const an = (e, t) => {
      ...
      if (
        ('supsub' === e.type
          ? ((r = e.sup), (n = e.sub), (o = Rt(e.base, 'operatorname')), (i = !0))
          : (o = Rt(e, 'operatorname')),
        o.body.length > 0)
      ) {
    ...
    Nr('\\dots', function (e) {
      ...
      return (
        r in qn
          ? (t = qn[r])
          : ('\\not' === r.slice(0, 4) || (r in se.math && l.contains(['bin', 'rel'], se.math[r].group))) &&
            (t = '\\dotsb'),
        t
      );
    });
    ...
    (Nr(
      '\\LaTeX',
      '\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{' + Rn + '}{\\scriptstyle A}\\kern-.15em\\TeX}{LaTeX}}'
    ),
      Nr(
        '\\KaTeX',
        '\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{' + Rn + '}{\\scriptstyle A}\\kern-.15em\\TeX}{KaTeX}}'
      ),
    ...
    class Fn {
      ...
      parseGroup(e, t) {
        ...
        if ('{' === o || '\\begingroup' === o) {
          ...
          ((s = this.parseFunction(t, e) || this.parseSymbol()), null == s && '\\' === o[0] && !On.hasOwnProperty(o))
        ) {
